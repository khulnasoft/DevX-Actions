...
[![Lines of Code](https://img.shields.io/badge/lines%20of%20code-6.5k-lightgrey?logo=codecademy)](https://github.com/KhulnaSoft/DevX-Actions)
[![License](https://img.shields.io/github/license/KhulnaSoft/DevX-Actions)](https://github.com/KhulnaSoft/DevX-Actions/blob/master/LICENSE)
...
[![GitHub Last Commit](https://img.shields.io/github/last-commit/KhulnaSoft/DevX-Actions?logo=github)](https://github.com/KhulnaSoft/DevX-Actions/commits/master)
...
[![YAML](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/yaml.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/yaml.yaml)
[![Markdown Lint](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/markdown.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/markdown.yaml)
[![Validation](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/validate.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/validate.yaml)
[![Grype](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/grype.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/grype.yaml)
[![Kics](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/kics.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/kics.yaml)
[![Semgrep](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/semgrep.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/semgrep.yaml)
[![Semgrep Cloud](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/semgrep-cloud.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/semgrep-cloud.yaml)
[![URL Links](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/url_links.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/url_links.yaml)
[![Trivy](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/trivy.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/trivy.yaml)

[![Repo on GitHub](https://img.shields.io/badge/repo-GitHub-2088FF?logo=github)](https://github.com/KhulnaSoft/DevX-Actions)
[![Repo on GitLab](https://img.shields.io/badge/repo-GitLab-FCA121?logo=gitlab)](https://gitlab.com/KhulnaSoft/DevX-Actions)
[![Repo on Azure DevOps](https://img.shields.io/badge/repo-Azure%20DevOps-0078D7?logo=azure%20devops)](https://dev.azure.com/khulnasoft/GitHub/_git/DevX-Actions)
[![Repo on BitBucket](https://img.shields.io/badge/repo-BitBucket-0052CC?logo=bitbucket)](https://bitbucket.org/KhulnaSoft/DevX-Actions)

GitHub Actions master template & GitHub Actions Reusable Workflows library.

- [main.yaml](https://github.com/KhulnaSoft/DevX-Actions/blob/master/main.yaml) - GitHub Actions master workflow template
- [.github/workflows/](https://github.com/KhulnaSoft/DevX-Actions/tree/master/.github/workflows) - GitHub Actions Reusable Workflows Library
...
[![Semgrep Cloud](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/semgrep-cloud.yaml/badge.svg)](https://github.com/KhulnaSoft/DevX-Actions/actions/workflows/semgrep-cloud.yaml) Alerts appear in the <https://semgrep.dev> dashboard
...
jobs:
  semgrep:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/semgrep.yaml@master
```
...
jobs:
  semgrep:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/semgrep-cloud.yaml@master
    secrets:
...
[![tfsec](https://github.com/KhulnaSoft/Terraform/actions/workflows/tfsec.yaml/badge.svg)](https://github.com/KhulnaSoft/Terraform/actions/workflows/tfsec.yaml)
...
jobs:
  tfsec:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/tfsec.yaml@master
```
...
jobs:
  terraform:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/terraform.yaml@master
    with:
...
For more sophisticated examples including approvals, secrets, branch and path selection etc. see my [Terraform repo](https://github.com/KhulnaSoft/Terraform)'s templates for [terraform-plan.yaml](https://github.com/KhulnaSoft/Terraform/blob/master/.github/workflows/terraform-plan.yaml.template) and [terraform-apply.yaml](https://github.com/KhulnaSoft/Terraform/blob/master/.github/workflows/terraform-apply.yaml.template)

## Docker Build and push to DockerHub

[![Docker Build DevOps Bash Tools (Ubuntu)](https://github.com/KhulnaSoft/Dockerfiles/actions/workflows/docker_build_devops_bash_tools_ubuntu.yaml/badge.svg)](https://github.com/KhulnaSoft/Dockerfiles/actions/workflows/docker_build_devops_bash_tools_ubuntu.yaml)
...
jobs:
  docker_build:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/dockerhub_build.yaml@master
    with:
...
jobs:
  docker_build:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/docker_build_aws_ecr.yaml@master
    with:
      repo: MY_ECR_REPO
    secrets:
...
Creates several useful tags, supports multi-stage build caching, see [README](https://github.com/KhulnaSoft/DevX-Actions/blob/master/.github/workflows/README.md) for details.
...
jobs:
  url_links:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/url_links.yaml@master
```

See [README](https://github.com/KhulnaSoft/DevX-Actions/blob/master/.github/workflows/README.md) for details on ignoring inaccessible / partially constructed links or those containing variables
...
jobs:
  merge:
    ...
    uses: KhulnaSoft/DevX-Actions/.github/workflows/merge-branch.yaml@master
    with:
...
jobs:
  gitlab_mirror:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/gitlab-mirror.yaml@master
    with:
...
jobs:
  aws_codeartifact_python_publish:
    uses: KhulnaSoft/DevX-Actions/.github/workflows/codeartifact_python_publish.yaml@master
    with:
...
Enable the [fork-sync](https://github.com/KhulnaSoft/DevX-Actions/blob/master/.github/workflows/fork-sync.yaml) github actions workflow in your fork to keep the master branch sync'd every few hours.

You can then create tags or environment branches in your forked repo to stage updates across dev/staging/production.

If using environment branches enable the [fork-update-pr](https://github.com/KhulnaSoft/DevX-Actions/blob/master/.github/workflows/fork-update-pr.yaml) github actions workflow to automatically raise GitHub Pull Requests from master to your environment branches to audit, authorize & control updates.
...
[![Star History Chart](https://api.star-history.com/svg?repos=KhulnaSoft/DevX-Actions&type=Date)](https://star-history.com/#KhulnaSoft/DevX-Actions&Date)
...
[![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=KhulnaSoft&repo=DevOps-Bash-tools&theme=ambient_gradient&description_lines_count=3)](https://github.com/KhulnaSoft/DevX)
